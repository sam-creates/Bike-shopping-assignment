...
export default function Login({navigation}) {
  return (
    ...
    <View style={{ flex: 1, justifyContent: "center", alignItems: "center"}}>
      ...
      <Image source={Bike} style={{ width: 170, height: 170, transform: [{rotate: '-45deg'}], borderRadius: 15, marginBottom: 60 }} />

      <Text style={{fontSize: 20, fontWeight: 500, color: 'rgba(0,0,0, .8)'}}>Welcome to</Text>
